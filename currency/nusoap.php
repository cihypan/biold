...
/*
$Id: nusoap.php,v 1.65 2003/12/18 03:31:20 snichol Exp $
...
* @version  $Id: nusoap.php,v 1.65 2003/12/18 03:31:20 snichol Exp $
* @access   public
*/
class nusoap_base {
	...
	function serializeType($name, $type, $value, $use='encoded', $encodingStyle=false)
	{
		...
		if ($phpType == 'struct') {
			...
			if ($use == 'literal') {
				...
				return "<$name xsi:type=\"" . $this->getPrefixFromNamespace($ns) . ":$uqType\"$encodingStyle>$value</$name>";
			}
		}
