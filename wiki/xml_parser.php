...
class SofeeXmlParser {
    ...
    */
    ...
    function parsewikiXML($term) {
		// Fake the browser type
		ini_set('user_agent','MSIE 4\.0b2;');
		
		// better way is through Special:Export xml
		$wiki_term = urlencode($term);
		$handle = fopen("http://en.wikipedia.org/wiki/Special:Export/".$wiki_term, "r");
